...
// اذا كان هناك اسم مستخدم فى جلسة يوزرنيم اذهب لصفحة الرئيسيه
...
if(isset($_POST['signup'])){
	...
	$qu = "insert into users (username,password,email,pic) value ('$user','$pass','$email','$pic')";
	
	// التحقق من نجاح الاستعلام 
	if(mysqli_query($con, $qu)){
		$smsg = 'تم انشاء الحساب بنجاح يمكنك تسجيل الدخول الان';
...
<div class="login">
    ...
    <form method="post">
		...
		<input type="text" name="pic" placeholder="profile picture URL" required="required" />
        <button type="submit" name="signup" class="btn btn-primary btn-block btn-large">Let me signup.</button>
    </form>
	<h1><?php echo $smsg; ?></h1>
</div>
