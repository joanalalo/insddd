			...
			<div class="row justify-content-center h-100">
				<div class="col-md-4 col-xl-3 chat"><div class="card mb-sm-3 mb-md-0 contacts_card">
					...
					<div class="card-body contacts_body">
						...
						<ui class="contacts">
						<li class="active" id="user_cont" name="pub" data-id="pic/pub.png">
							<div class="d-flex bd-highlight">
								<div class="img_cont">
									<img src="pic/pub.png" class="rounded-circle user_img">
						...
						<ui id="user_online" class="contacts">
				...
				<div class="col-md-8 col-xl-6 chat">
					<div class="card">
						<div class="card-header msg_head">
							<div class="d-flex bd-highlight">
								<div class="img_cont">
									<img id="cont_img" src="pic/pub.png" class="rounded-circle user_img">
									<span class="online_icon"></span>
								</div>
								<div class="user_info">
									<span id="cont_name">pub</span>
									<p>1767 Messages</p>
								</div>
								<div class="video_cam">
						...
						<div id="msg_table" class="card-body msg_card_body">
...
// فى البدايه سوف نحدد المتغيرات الرئيسيه
    
	// هذا للاحتفاظ باسم المستخدم للعمل به فيما بعد
	var user = "<?php echo $_SESSION['username']; ?>";
	// متغيرات العرض
	// متغير جدول الرسائل
	var msgdiv = $('#msg_table');
	// متغير الاعضاء المتصلين الان
	var user_online = $('#user_online');
	// متغير عدد الاعضاء المتصلين
	var total_online = $('#total_online');
	// متغير اسم المستلم
	var tou = $('#cont_name');
	// متغير صورة المستلم
	var tupic = $('#cont_img');
    ...
    // سوف ننشىء داله للاستخدام المتكرر
	// دالة استقبال الرسائل
	
	function recv(){
		// هذا المتغير يستخدم لتحديد الرسائل المطلوبه اذا كانت عامه او خاصه
		var touser = tou.html();
		$.ajax({
			method:"POST",
			url:"ajax/sr.php",
			data:{user:user,touser:touser},
			success:function(data){
				// عند نجاح العمليه عرض الرسائل فى جدول الرسائل
				msgdiv.html(data);
			}
		});
	}
	...
	function send(){
		var touser = tou.html();
		// هذا المتغير لحقل ارسال الرسائل
		var msg = $('#msg').val();
		$.ajax({
			method:"POST",
			url:"ajax/sr.php",
			data:{user:user,msg:msg,touser:touser},
			success:function(data){
				// عند نجاح العمليه عرض الرسائل فى جدول الرسائل
				msgdiv.html(data);
				// عند ارسال رساله سحب السكرول بار للاسفل
				msgdiv.scrollTop(msgdiv.prop("scrollHeight"));
				// افراغ محتوى حقل الادخال
				$('#msg').val('');
			}
		});
	}
	...
	// عند الضغط enter على حقل الادخال
	...
	// عند الضغط على متصل فى قائمة المتصلين الان
	$(document).on('click', '#user_cont', function(){
		// الاحتفاظ بصورة العضو واسمه لجلب الرسائل وارسال الرسائل
	...
	// والان انشاء دالة التحديث لتحديث الرسائل والمتصلين الان
	// الموضوع بدائى وهناك ادوات افضل من ذالك لمثل هذه الظروف ولكن الان سوف نستخدم الاتى
	...
	window.setInterval(function(){
		...
		$.ajax({
			method:"POST",
			url:"ajax/on_users.php",
			success:function(data){
				// سوف نقوم باستقبال البيانات على هيئة مصفوفه array
				var ar = eval(data);
				// اضافة الاعضاء للعرض
				user_online.html(ar[0]);
				// اضافة عددهم للعرض
				total_online.html(ar[1]+' is online now');
			}
		});
	}, 2000);
